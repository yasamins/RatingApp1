$(document).ready(function(){
  //selector of submit button in company ejs
  $('#register').on('click', function(){
    //id of the name sector with the value
    ...
    if(isValid == true){
      //if its valid we will save the data inside this object
      var companyData = {
        name:name,
        address: address,
        city: city,
      ...
      $.ajax({
        ...
        success: function(data){
          //if the request is successfull we will empty the input firlds
          $('#name').val('');
          $('#address').val('');
          $('#city').val('');
          $('#country').val('');
